...
const AddAnnouncements = ({ isModalVisible, setIsModalVisible, fetchAnnouncements }) => {
    ...
    <Modal
      ...
      <Form
        ...
        <Form.Item
          ...
          className="mt-3"
          rules={[
            { required: true, message: "Please input your announcements title!" },
          ]}>
        ...
        <Form.Item
          ...
          <Upload
            ...
            beforeUpload={() => false}
            maxCount={1}>
            <Button icon={<UploadOutlined />}>Select announcements attachment</Button>
          </Upload>
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: "Please input your announcements content!" },
          ]}>
          <ReactQuill
            className="h-[200px]"
            theme="snow"
