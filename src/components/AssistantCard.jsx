            ...
            <div>
              ...
              <Radio.Group
                ...
                <Radio value="penalty">
                  ...
                  The assistant's maximum rating will decrease, and this will
                  count as a failed job.
                </Radio>
                <Radio value="no_penalty">
                  <span className="font-medium">Reassign without penalty</span>{" "}
                ...
                <Radio value="replacement">
                  ...
                  paid for any jobs applied for. (Recommended for jobs where the
                  assistant hasn't started applying yet.)
                </Radio>
              </Radio.Group>
              <Form
                className="mt-4"
